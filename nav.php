...
<nav>
    <ul style="list-style-type: none; padding: 0; margin: 0; background-color: #4CAF50; overflow: hidden; border-radius: 8px;">
        <li style="float: left;">
        ...
        <li style="float: left;">
            <a href="form.php" style="display: block; color: white; text-align: center; padding: 14px 16px; text-decoration: none;">Agregar Producto</a>
        </li>
    </ul>
</nav>
